...
// Schemas and Models
const itemSchema = new mongoose.Schema({ name: String, weight: Number, material: String });
const Item = mongoose.model('Item', itemSchema);

const employeeSchema = new mongoose.Schema({ first_name: String, last_name: String, room_number: Number });
